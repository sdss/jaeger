...
# @Last modified time: 2019-05-13 17:29:57
...
async def goto(command, fps, positioner_id, alpha, beta, speed=[None, None]):
    """Sends a positioner to a given (alpha, beta) position."""

    fps.positioners[positioner_id].goto(alpha, beta,
                                        alpha_speed=speed[0],
                                        beta_speed=speed[1])
