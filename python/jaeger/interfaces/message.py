...
# Copied from the python-can package.
...
class Message(object):
    ...
    def id_type(self):
        # TODO remove in 4.0
        warnings.warn(
            "Message.id_type is deprecated and will be removed "
            "in 4.0, use is_extended_id instead",
            DeprecationWarning,
        )
    ...
    def __init__(
        ...
        if extended_id is not None:
            # TODO remove in 4.0
            warnings.warn(
                "The extended_id parameter is deprecated and will "
                "be removed in 4.0, use is_extended_id instead",
                DeprecationWarning,
            )
